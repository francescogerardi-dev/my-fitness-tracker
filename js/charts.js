...
export function renderChart() {
    ...
    */
    ...
    mainChart = new Chart(ctx, {
        ...
        options: { responsive: true, maintainAspectRatio: false, plugins: { legend: { display: false },title: {display: true,text: 'Weekly Chart',font-size: '1.2rem'} }, scales: { y: { min: 73, max: 81 } } },
        plugins: [{ 
            afterDraw: chart => { 
